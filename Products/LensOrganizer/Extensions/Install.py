...
from Products.LensOrganizer.config import PROJECTNAME
from Products.LensOrganizer.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install LensOrganizer """
    out = StringIO()
    ...
    try:
        from Products.LensOrganizer.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.LensOrganizer.config import STYLESHEETS
    try:
        ...
        pass
    from Products.LensOrganizer.config import JAVASCRIPTS
    try:
